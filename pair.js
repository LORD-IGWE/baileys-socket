        ...
        try {
            ...
            GlobalTechInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = 'sektor~' stringSession;  // Prepend your name to the session ID
                    ...
                    await GlobalTechInc.sendMessage(userJid, { text: 'Hello  Thanks for choosing sektor Md🗿🗿 \n' });
